...
| CANCELED (not Used) | The CANCELED field is a Boolean indicator that checks whether the flight status contains the word “Canceled”. If the flight was marked as canceled in Flightradar, this field is set to True, otherwise it is set to False. | 
